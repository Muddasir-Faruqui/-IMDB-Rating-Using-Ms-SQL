...
-- IN 2017 HIGHEST NUMBER MOVIES RELEASED
...
-- MARCH AS HIGHEST AND DECEMBER AS LEAST MOVIE RELEASE 
...
WHERE year=2019 
      ...
      ;
-- NUMBER OF MOVIES PRODUCE IN USA AND INDIA IN 2019 IS 1059 MOVIES
...
-- DRAMA AS HIGHEST MOVIE PRODUCED IS 4285 
...
FROM genre
GROUP BY movie_id
ORDER BY genre_count DESC) as genre_count
WHERE genre_count=1
GROUP BY genre_count;

-- 3289 MOVIES AS EXACTLY A SINGLE GENRE.
...
-- DURATION OF ACTION MOVIE IS 112.88MIN WHICH IS HIGEST DURATION GENRE
-- DURATION OF HORROR MOVIE IS 92.72MIN WHICH IS LOWEST DURATION GENRE
...
-- Dream Warrior Pictures and National Theatre Live as highest number of hits
